...
try {
  ...
  for (const [name, width, height] of [['desktop', 1440, 900], ['mobile', 390, 844], ['prototype-size', 757, 426]]) {
  ...
  console.log('Saved desktop, mobile and prototype-size screenshots in design/previews/.');
} finally {
  await browser.close();
}
